...
import { setAdProduct, setProductDetails } from "../../Redux/action";
...
const Edit = () => {
  ...
  // useEffect(() => {
  //   // This useEffect hook will execute whenever 'product' state changes
  //   console.log("Product updated:", product);
  // }, [product]); // Specify 'product' as dependency
